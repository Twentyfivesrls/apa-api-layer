...
@FeignClient(name = "TwentyfiveController", url = "http://80.211.123.141:8080")
public interface TwentyfiveKeycloakClientController {
    ...
    @RequestMapping(method = RequestMethod.GET, value = "/admin/realms/${keycloak.realm.internal}/users", produces = "application/json")
    ResponseEntity<List<UserRepresentation>> getUserFromUsername(@RequestHeader("Authorization") String accessToken,
                                                                 @RequestParam String username);

    @RequestMapping(method = RequestMethod.GET, value="/admin/realms/${keycloak.realm.internal}/ui-ext/brute-force-user")
    ResponseEntity<List<UserRepresentation>> search(@RequestHeader("Authorization") String accessToken, @RequestParam String search);

    @RequestMapping(method = RequestMethod.POST, value = "/admin/realms/${keycloak.realm.internal}/users", produces = "application/json")
    ResponseEntity<Object> add(@RequestHeader("Authorization") String accessToken, @RequestBody UserRepresentation user);
    @RequestMapping(method = RequestMethod.PUT, value ="/admin/realms/${keycloak.realm.internal}/users/{id}")
    ...
    @RequestMapping(method = RequestMethod.DELETE, value = "/admin/realms/${keycloak.realm.internal}/users/{id}", produces = "application/json")
    ResponseEntity<Object> delete(@RequestHeader("Authorization") String accessToken, @PathVariable String id);

    @RequestMapping(method = RequestMethod.PUT, value = "/admin/realms/${keycloak.realm.internal}/users/{id}/reset-password", produces = "application/json")
    ...
    @RequestMapping(method = RequestMethod.GET, value = "/admin/realms/${keycloak.realm.internal}/ui-ext/available-roles/users/{id}", produces = "application/json")
    ...
    @RequestMapping(method = RequestMethod.POST, value = "/admin/realms/${keycloak.realm.internal}/users/{id}/role-mappings/clients/{clientIdRole}", produces = "application/json")
    ...
    @RequestMapping(method = RequestMethod.DELETE, value = "/admin/realms/${keycloak.realm.internal}/users/{id}/role-mappings/clients/{clientIdRole}", produces = "application/json")
    ResponseEntity<Object> deleteRoleToUser(@RequestHeader("Authorization") String accessToken,
                                            @PathVariable String id,
                                            @PathVariable String clientIdRole,
                                            @RequestBody List<RoleRepresentation> roles);
    @RequestMapping(method = RequestMethod.GET, value = "/admin/realms/${keycloak.realm.internal}/users/{id}/role-mappings", produces = "application/json")
